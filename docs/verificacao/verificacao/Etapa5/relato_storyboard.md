## Introdução
Depois que realizamos o planejamento da avaliação vamos agora verificar os artefatos

## Objetivo
Esse artefato tem como obejtivo avaliar os storyboards feitos pelo grupo 04 de Interação Humano Computador(IHC)

## Metodologia
A metodologia ultilizada é a de inspeção nos verificamos, os checklist planejados
...
## 3- Validar Antecedentes Criminais 
### Checklist Storyboards
...
| :----------------------------------------------------------: | :-------------------------------: | :-------------------------------------------------: | :-------------------------------: |  :-------------------------------: | :-------------------------------: |
| 1.0 | Verificando denuncia online |  [Giovana Barbosa](https://github.com/gio221) | 17/06 | | |
