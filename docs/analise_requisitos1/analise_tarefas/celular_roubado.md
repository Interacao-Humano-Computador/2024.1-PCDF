# Introdução
No site do PCDF escolhemos algumas funcionalidade, entre elas a do bloqueio quando o celular é roubado. A integrante  [Giovana Barbosa](https://github.com/gio221) ficou responsável por essa funcionalidade.Para isso foi escolhido a Análise Hierárquica de Tarefas e a GOMS
